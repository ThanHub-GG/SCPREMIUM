...
local Custom = {} do
    ...
    Custom.ColorRGB = Color3.fromRGB(112, 41, 255) -- purple
    Custom.AccentColor = Color3.fromRGB(45, 110, 255) -- blue accent
    Custom.DarkBlue = Color3.fromRGB(40, 20, 50) -- dark purple
    Custom.BackgroundDark = Color3.fromRGB(10, 10, 15) -- near black
    Custom.FrameDark = Color3.fromRGB(25, 15, 35) -- deep frame
    
    -- Button colors (adapted to new palette)
    Custom.MacRedButton = Color3.fromRGB(112, 41, 255)
    Custom.MacYellowButton = Color3.fromRGB(45, 110, 255)
    Custom.MacGreenButton = Color3.fromRGB(20, 20, 20)
...
function Speed_Library:SetNotification(Config)
    ...
    Custom:Create("UICorner",{Parent=Top,CornerRadius=UDim.new(0,6)})
...
function Speed_Library:CreateWindow(Config)
  ...
  local SpeedHubXGui = Custom:Create("ScreenGui", {
    ...
    -- Small top buttons (square style)
    local TweenService = game:GetService("TweenService")
    ...
    local buttonTween = TweenService:Create(GreenButton, tweenInfo, {
    ...
    YellowButton.Activated:Connect(function()
        -- Hover effect
        TweenService:Create(YellowButton, TweenInfo.new(0.1), {BackgroundColor3 = Color3.fromRGB(100, 160, 255)}):Play()
        task.wait(0.1)
    ...
    RedButton.Activated:Connect(function()
        -- Hover effect
        TweenService:Create(RedButton, TweenInfo.new(0.1), {BackgroundColor3 = Color3.fromRGB(150, 90, 255)}):Play()
        task.wait(0.1)
    ...
    RedButton.MouseEnter:Connect(function()
        TweenService:Create(RedButton, TweenInfo.new(0.15), {BackgroundColor3 = Color3.fromRGB(150, 90, 255)}):Play()
    end)
    ...
    YellowButton.MouseEnter:Connect(function()
        TweenService:Create(YellowButton, TweenInfo.new(0.15), {BackgroundColor3 = Color3.fromRGB(100, 160, 255)}):Play()
    end)
